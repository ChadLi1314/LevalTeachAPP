		...
		<table border="1" width="47%" height="250" style="border-width: 0px">
			...
			<tr>
				<td style="border-style: none; border-width: medium">　
					<form target="myframe" class="contact_form" action="${pageContext.request.contextPath}/evaluate/AddQuestion.action" method="post" name="contact_form">
					    <ul>
					        <li>
					             <h2>选项管理</h2>
...
<!-- 					        <li>
					            <label for="name" style="font-size: 18px;">问题内容:</label>
					            <input type="text" name="iname"  placeholder="不包括特殊内容，必填项:" required />
					        </li> -->
					        <li>
		          			  <label for="message">问题内容:</label>
		          			  <textarea name="content" cols="40" rows="4" placeholder="不包括特殊内容，必填项:" required ></textarea>
		        			</li>
					        <li>
