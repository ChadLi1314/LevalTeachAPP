...
<html>
  ...
  <div style="margin-left: 1150px; width: 150px;height: 60px;"><a href="${pageContext.request.contextPath }/showcourse/toupdateStudent.action">修改个人密码</a></div>
<ul>
<c:forEach items="${courses }" var="v">
	<li>
		<a href="${pageContext.request.contextPath}/evaluate/toEvaluateJsp.action?c_id=${v.c_id}">
			<div id="div1">
				<div id="div2">
