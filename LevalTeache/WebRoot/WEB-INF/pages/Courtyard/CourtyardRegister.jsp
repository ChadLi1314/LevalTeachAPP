		...
		<table border="1" width="47%" height="250" style="border-width: 0px">
			...
			<tr>
				<td style="border-style: none; border-width: medium">　
					<form target="myframe" class="contact_form" action="${pageContext.request.contextPath}/courtyard/insert.action" method="post" name="contact_form">
					    <ul>
					        <li>
					             <h2>注册院系</h2>
					        ...
					        <li>
					            <label for="name" style="font-size: 18px;">院系名称:</label>
					            <input type="text" name="iname"  placeholder="院系名称，不包含特殊字符" required />
					        </li>
					        <li>
