...
<html>
  ...
  <body>
		...
		<header class="htmleaf-header">
			<h1 style="font-family:Microsoft YaHei;color: #8FDAC3;">管理员登录</h1>
			<div class="htmleaf-links" style="margin-top: 10px;">
				...
				<a style="margin-left: 60px;font-family:Microsoft YaHei;color: #8FDAC3;" class="htmleaf-icon icon-htmleaf-arrow-forward-outline" href="${pageContext.request.contextPath }/index1.jsp" title="教师登录">教师登录</a>
			</div>
		</header>
		<div class="wrapper">
			<div class="container">
				...
				<%
					...
					%>
				<form class="form" action="${pageContext.request.contextPath }/login/managerlogin.action" method="post">
					<input type="text" name="m_id" placeholder="输入ID号:" required>
